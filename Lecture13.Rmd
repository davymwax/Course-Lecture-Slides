...
>- A slightly more general form of Bayes Theorem says that if $\{E_{1}, E_{2}, E_{3}, E_{4}, \dots, E_{n}\}$ is a partition of an event $E$, then for any $E_{i} \subset E$: \begin{center} \[
\boxed{
