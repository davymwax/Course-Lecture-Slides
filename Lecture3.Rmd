...
>- The process of drawing a conclusion or inferring a claim is called \textcolor{red}{deduction} if the premises \textcolor{red}{entail} the conclusion. 

>- To understand what the word "entail" means, we need the truth table for the truth function $(p \to q)$, which is read as "If $p$, then $q$". See \textcolor{red}{Homework 1} for why $(p \to q)$ is truth-functionally equivalent to $(\lnot p \vee q)$.
\begin{center}
...
>- Consider the argument form which says that from a formula $F$ and $\lnot F \vee G$, infer $G$. An \textcolor{red}{instance} of this argument is:\begin{itemize} \item[1.] Either I will have bacon for breakfast or I will have toast. \item[2.] I will not have bacon. \item[$\therefore$3.] I will have toast for breakfast.\end{itemize}

>- Another \textcolor{red}{instance} of this argument is:\begin{itemize}\item[1.] Either the moon is made of green cheese or $2 + 2 = 5$ \item[2.] $2 + 2 \neq 5$ \item[$\therefore$3.] The moon is made of green cheese. \end{itemize}
