...
>- You cannot bring both to the dinner party because you're on a budget. So you are faced with \textcolor{red}{a decision problem} which we may represent in the following \textcolor{red}{decision table} (the right table) and corresponding
\textcolor{red}{desirability table} (the left table).
...
>- Since consequences are joint functions of acts and states, we can calculate the expected value of taking and act $A_{i}$, given state $S_{i}$.
...
>- How would you advice President Biden?
