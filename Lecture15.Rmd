...
>- More specifically, the weighted average of \textcolor{red}{the unfavorable consequences of an act} where the weights on the consequences are determined by the probability distribution on states is the risk of that act.
...
Exercise. Suppose that President Biden knows that the odds are 3:5 that a deal will be reached with the U.S. House of Representative Majority Leader Kevin McCarthy. What act would you advice President Biden to take in order to avoid having the Federal Government default on its debt?
