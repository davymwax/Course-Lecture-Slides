...
>- In his \textit{A Treatise of Human Nature}, David Hume (1739 - 1849) used some of the above features of deductive inference to call into serious question the thesis that we have any logical or rational basis for inductive reasoning about \textcolor{red}{causality}, i.e., reasoning of the form $A$ \textcolor{red}{causes} $B$.
