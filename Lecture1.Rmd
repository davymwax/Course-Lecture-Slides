...
>- Closure condition: Nothing else is a formula.
...
\begin{enumerate} \item $p$, $q$, $r$, $s$ and $t$ as symbols for sentences. If we need more than 5 symbols (rarely!), then add the following countably many symbols $p_{1}$, $p_{2}$, $p_{3}$, \dots.
