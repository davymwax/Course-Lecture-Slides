...
>- A slightly more general form of Bayes Theorem says that if $\{E_{1}, E_{2}, E_{3}, E_{4}, \dots, E_{n}\}$ is a partition of $E$, then:\[
\boxed{
P(E \,| \, F) = \frac{P(F | E) P(E)}{\sum_{i}^{n}P(F|E_{i})P(E_{i})}
}
\]
