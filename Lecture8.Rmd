...
\item Kolmogorov Axioms for Probability
\end{itemize}
...
>- Let us agree to call a favorable consequence (\textcolor{red}{a utility}) and an unfavorable consequence (\textcolor{red}{a loss}). These term or elements or elements can be subjective and need not have anything to do with money or happiness.
...
>- For the rest of the quarter we shall spend our time doing probability theory, with the interpretation of probability and how conditional probability can be applied in the context of inductive logic as we have defined it.
...
>- Remember how started studying deductive logic by saying what the rules of formation for formulas were. Here we're going to begin by saying what ways of putting sets together lead to the sorts of sets which probability can handle.
...
>- Nowhere is this truth illustrated than in the study of sets. You might think that any predicate, $Px$, determ or elementines a set $\{ x | Px \}$, i.e., "the set of those $x$'s that a Ps." And you would be wrong!
