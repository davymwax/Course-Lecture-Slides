...
\begin{itemize}
\item[4] If $\mathcal{F}$ is a formula by rule 3, then the result of \textcolor{red}{binding} any free variable in $\mathcal{F}$ and closing everything up with one left and one right parenthesis is a formula.

\item[5] A formula $\mathcal{F}$ formed by either rule 1, 2, 3 or 4 is called an \textcolor{red}{atomic formula}.

\item[6] If $\mathcal{F}$ and $\mathcal{G}$ are atomic formulas then $(\lnot \mathcal{F})$, $(\mathcal{F} \vee \mathcal{G})$, $(\mathcal{F} \wedge \mathcal{G})$, $(\mathcal{F} \to \mathcal{G})$ and $(\mathcal{F} \leftrightarrow \mathcal{G})$ are \textcolor{red}{complex formulas}.
\item[7] If $\mathcal{H}$ is a complex formula, then the result of \textcolor{red}{binding} any free variable in $\mathcal{H}$ and closing everything up with one left and one right parenthesis is a formula. 
\end{itemize}

# Quantified Relational Logic: The Logic Itself

>- The \textcolor{red}{Closure Condition} says that a formula of quantified relational logic is either an atomic formula or a complex formula built from atomic formulas by \textcolor{red}{finite applications} of rule 5, 6 and 7. Nothing else is a formula.
