...
\item[4.] If $\mathcal{H}$ is a complex formula, then the result of \textcolor{red}{binding} any free variable in $\mathcal{H}$ and closing everything up with one left and one right parenthesis is a formula. 
\end{itemize}
